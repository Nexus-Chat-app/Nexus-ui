      ...
      {!isOtpStep ? (
        <Form {...loginForm}>
          <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter your email" {...field} className="bg-white/50 dark:bg-gray-800/40 text-black dark:text-white border-0" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem>
                  ...
                  <div className='relative'>
                    <Input
                      ...
                      placeholder="********"
                      {...field} className="bg-white/50 dark:bg-gray-800/40 text-black dark:text-white border-0" />
                    <button
                      type="button"
            ...
            />
            <Button type="submit" className="w-full text-white border border-white bg-blue-500/80 dark:bg-red-500/80 rounded-xl">Log in</Button>
          </form>
        </Form>
      ) : (
        <Form {...otpForm}>
          <form onSubmit={otpForm.handleSubmit(onOtpSubmit)} className="space-y-4 flex-col flex items-center ">
            ...
            />
            <Button type="submit" className="w-full text-white border border-white bg-blue-500/80 dark:bg-red-500/80 rounded-xl">Verify OTP</Button>
          </form>
        </Form>
      )}
    </div>
